...
ifndef EMBEDDED
	...
	END { \
		print_cat("Documentation & Help", "help help-examples help-aliases help-ravnvm help-omarchyvm doc-local doc-dev doc-build doc-install doc-clean"); \
		...
		print_cat("Development Tools", "dev-setup dev-vm dev-vm-persist dev-vm-list dev-vm-clean dev-vm-setup dev-vm-storage dev-vm-size dev-vm-ssh dev-vm-install-ssh-alias dev-vm-external dev-omarchy dev-omarchy-persist dev-omarchy-rebuild dev-omarchy-list dev-omarchy-clean dev-omarchy-setup dev-omarchy-storage dev-omarchy-ssh dev-omarchy-install-ssh-alias"); \

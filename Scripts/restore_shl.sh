...
# ==============================================================================
# Verificación del soporte e instalación de la Shell deseada
# ==============================================================================
...
# ==============================================================================
# Configuración y aprovisionamiento de plugins de Zsh a través de oh-my-zsh
# ==============================================================================
if pkg_installed zsh; then
    ...
    # ==========================================================================
    # Clonación e integración de plugins adicionales especificados en restore_zsh.lst
    # ==========================================================================
    if (pkg_installed oh-my-zsh-git || [[ -f "${HOME}/.oh-my-zsh/oh-my-zsh.sh" ]]) && [ "${flg_DryRun}" -ne 1 ]; then
        ...
        sed -i "/^ravn_plugins=/c\ravn_plugins=(${w_plugin} )${Fix_Completion}" "${Zsh_rc}"
    else
...
# ==============================================================================
# Cambio de la Shell predeterminada del usuario
# ==============================================================================

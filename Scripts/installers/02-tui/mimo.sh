...
install() {
    ...
    # --: Marca el fin de las opciones de Bash. Todo lo que venga después de -- será ignorado
    #     por Bash y se pasará directamente como argumento al script que se está ejecutando.

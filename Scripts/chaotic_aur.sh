...
# ==============================================================================
# Verificaciones iniciales de permisos y variables
# ==============================================================================
execName="$0 $*"
rootOpts=("--install" "--purge" "--revert" "fresh")
vertL="$(printf '=%.0s' $(seq 1 "$(tput cols)"))"

# ==============================================================================
# Función para mostrar mensajes de estado formateados en consola
# ==============================================================================
box_me() {
    local s="RaVN: $*"
    tput setaf 3
...
# ==============================================================================
# Verificación de permisos de súper-usuario (Root)
# ==============================================================================
check_Root() {
    if [ "$EUID" -ne 0 ]; then
...
# ==============================================================================
# Verificación de la conexión a Internet mediante Ping
# ==============================================================================
check_Ping() {
...
# ==============================================================================
# Escritura y eliminación de la sección Chaotic-AUR en pacman.conf
# ==============================================================================
write_ChaoticAUR() {
    is_ChaoticAUR=$(
...
# ==============================================================================
# Verificación de la integridad de los paquetes y firmas del Chaotic AUR
# ==============================================================================
check_Integrity() {
    is_ChaoticAUR=$(
        grep "chaotic-aur" /etc/pacman.conf >/dev/null 2>&1
...
# ==============================================================================
# Proceso de instalación e importación de firmas del repositorio
# ==============================================================================
install() {
    handle_error() {
        tput setaf 1
...
# ==============================================================================
# Proceso de eliminación (Purga) de las claves y repositorios del Chaotic AUR
# ==============================================================================
purge() {
    if pacman-key -l | grep 3056513887B78AEB >/dev/null; then
...
# ==============================================================================
# Reinstalación de paquetes desde las fuentes oficiales del AUR (Reversión)
# ==============================================================================
revertAUR() {
...
# ==============================================================================
# Mensaje informativo para instalaciones limpias del sistema
# ==============================================================================
fresh() {
    clear
...
RaVN is not affiliated with Chaotic AUR.

CHAOS

    read -p "Type 'yes' to continue [default] No : " -r add_chaotic
...
# ==============================================================================
# Orquestador del menú de opciones y parámetros
# ==============================================================================
